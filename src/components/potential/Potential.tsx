...
const Potential = () => {
    return (
        <section className=' w-full flex items-center justify-center flex-col py-11 '>
            <h1 className='font-extrabold text-[48px] leading-[48px] text-[#1D293C] dark:text-[#F1F5F9] w-full text-center'>Unlock Your Potential</h1>
            <div className='relative flex gap-10 mt-10 flex-col-reverse md:flex-row items-center justify-center px-6 py-6 z-10'>
                <div className='font-medium ~text-[20px]/[30px] ~leading-[18px]/[36px] text-[#1D293C] dark:text-[#F1F5F9] ~max-w-[370px]/[720px] z-10'>
