...
class CParser(PLYParser):
    ...
    def _add_declaration_specifier(self, declspec, newspec, kind, append=False):
        ...
        """
        spec = declspec or dict(qual=[], storage=[],
    ...
    def p_specifier_qualifier_list_4(self, p):
        ...
        """
        p[0] = dict(qual=p[1], alignment=[], storage=[],
                    type=[p[2]], function=[])

    def p_specifier_qualifier_list_5(self, p):
        """ specifier_qualifier_list  : alignment_specifier
        """
        p[0] = dict(qual=[], alignment=[p[1]],
    ...
    def p_struct_declarator_2(self, p):
        ...
        if len(p) > 3:
            ...
            p[0] = {'decl': c_ast.TypeDecl(
                None, None, None, None), 'bitsize': p[2]}
