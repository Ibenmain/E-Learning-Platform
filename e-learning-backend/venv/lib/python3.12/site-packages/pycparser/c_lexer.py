...
class CLexer:
    ...
    def __init__(
        self, error_func, on_lbrace_func, on_rbrace_func,
        type_lookup_func,
    ):
        """ Create a new Lexer.
    ...
    decimal_constant = '(0'+integer_suffix_opt + \
        ')|([1-9][0-9]*'+integer_suffix_opt+')'
    ...
    escape_sequence = r"""(\\("""+simple_escape+'|' + \
        decimal_escape+'|'+hex_escape+'))'
    ...
    hex_fractional_constant = '((('+hex_digits+r""")?\.""" + \
        hex_digits+')|('+hex_digits+r"""\.))"""
    hex_floating_constant = '('+hex_prefix+'('+hex_digits+'|' + \
        hex_fractional_constant+')'+binary_exponent_part+'[FfLl]?)'
