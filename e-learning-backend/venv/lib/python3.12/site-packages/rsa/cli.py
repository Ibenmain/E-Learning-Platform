...
Indexable = typing.Union[tuple, list[str]]
...
class CryptoOperation(metaclass=abc.ABCMeta):
    ...
    def parse_cli(self) -> tuple[optparse.Values, list[str]]:
        """Parse the CLI options
    ...
    def read_key(self, filename: str, keyform: str) -> rsa.key.AbstractKey:
        ...
        print('Reading {} key from {}'.format(
            self.keyname, filename), file=sys.stderr)
