...
class Section(dict):
    ...
    def merge(self, indict):
        ...
        for key, val in list(indict.items()):
            if (
                key in self and isinstance(self[key], dict) and
                isinstance(val, dict)
            ):
                self[key].merge(val)
            else:
    ...
    def walk(
        self, function, raise_errors=True,
...
class ConfigObj(Section):
    ...
    def __init__(
        self, infile=None, options=None, configspec=None, encoding=None,
    ...
    def _quote(self, value, multiline=True):
        ...
        * Obey list syntax for empty and single member lists.
        ...
        if multiline and isinstance(value, (list, tuple)):
            ...
            return ', '.join([
                self._quote(val, multiline=False)
                for val in value
            ])
        if not isinstance(value, str):
            if self.stringify:
    ...
    def write(self, outfile=None, section=None):
        ...
        if (self.filename is None) and (outfile is None):
            ...
            if (
                self.BOM and ((self.encoding is None) or
        ...
        if (
            getattr(outfile, 'mode', None) is not None and outfile.mode == 'w'
    ...
    def validate(
        self, validator, preserve_errors=False, copy=False,
        section=None,
    ):
        """
