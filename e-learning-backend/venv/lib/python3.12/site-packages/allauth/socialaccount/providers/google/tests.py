    ...
    def test_email_verified(self):
        ...
        self.assertFalse(
            EmailConfirmation.objects.filter(
                email_address__email=self.email).exists(),
        )
...
@pytest.mark.parametrize(
    ...
    [
        (True, True, {'id_token': '123'},
         'uid-from-id-token', 'pic-from-id-token'),
        (True, False, {'id_token': '123'},
         'uid-from-id-token', 'pic-from-userinfo'),
        (True, True, {'access_token': '123'},
         'uid-from-userinfo', 'pic-from-userinfo'),
    ],
)
