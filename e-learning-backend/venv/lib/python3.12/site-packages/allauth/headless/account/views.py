...
from allauth.account.internal.flows import password_change
...
from allauth.headless.account.inputs import ConfirmLoginCodeInput
from allauth.headless.account.inputs import DeleteEmailInput
from allauth.headless.account.inputs import LoginInput
from allauth.headless.account.inputs import MarkAsPrimaryEmailInput
from allauth.headless.account.inputs import ReauthenticateInput
from allauth.headless.account.inputs import RequestLoginCodeInput
from allauth.headless.account.inputs import RequestPasswordResetInput
from allauth.headless.account.inputs import ResetPasswordInput
from allauth.headless.account.inputs import ResetPasswordKeyInput
from allauth.headless.account.inputs import SelectEmailInput
...
from allauth.headless.base.response import ConflictResponse
...
class LoginView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        flows.login.perform_password_login(
...
class VerifyEmailView(APIView):
    ...
    def handle(self, request, *args, **kwargs):
        self.stage = LoginStageController.enter(
            request, EmailVerificationStage.key)
        if (
            not self.stage
...
class ManageEmailView(AuthenticatedAPIView):
    ...
    def _respond_email_list(self):
        addrs = manage_email.list_email_addresses(
