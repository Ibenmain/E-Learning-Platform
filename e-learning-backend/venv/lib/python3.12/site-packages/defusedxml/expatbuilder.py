...
from .common import DTDForbidden
from .common import EntitiesForbidden
from .common import ExternalReferenceForbidden
...
class DefusedExpatBuilder(_ExpatBuilder):
    ...
    def defused_unparsed_entity_decl(self, name, base, sysid, pubid, notation_name):
        # expat 1.2
        raise EntitiesForbidden(name, None, base, sysid,
                                pubid, notation_name)  # pragma: no cover
