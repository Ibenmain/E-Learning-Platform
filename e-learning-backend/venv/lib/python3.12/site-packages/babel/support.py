...
class Format:
    ...
    def datetime(self, datetime=None, format='medium'):
        ...
        return format_datetime(
            datetime, format, tzinfo=self.tzinfo,
            locale=self.locale,
        )
    ...
    def timedelta(
        self, delta, granularity='second', threshold=.85,
...
class LazyProxy:
    ...
    __slots__ = ['_func', '_args', '_kwargs', '_value',
                 '_is_cache_enabled', '_attribute_error']
...
class NullTranslations(gettext.NullTranslations):
    ...
    def lpgettext(self, context, message):
        ...
        encoding = getattr(self, '_output_charset',
                           None) or locale.getpreferredencoding()
    ...
    def dnpgettext(self, domain, context, singular, plural, num):
        ...
        `domain`.
        """
        return self._domains.get(domain, self).npgettext(
            context, singular,
            plural, num,
        )
