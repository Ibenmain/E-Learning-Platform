...
__all__ = [
    'UnknownLocaleError', 'Locale', 'default_locale', 'negotiate_locale',
    'parse_locale',
]
...
class Locale:
    ...
    def parse(cls, identifier, sep='_', resolve_likely_subtags=True):
        ...
        if identifier is None:
            ...
            raise TypeError(
                'Unexpected value for identifier: {!r}'.format(identifier))
        ...
        territory = get_global('territory_aliases').get(
        ...
        if likely_subtag is not None:
            ...
            locale = _try_load_reducing(
                (language2, territory, script2, variant2))
            if locale is not None:
                return locale
