    ...
    def _run_domain(self, domain):
        ...
        for idx, (locale, po_file) in enumerate(po_files):
            ...
            if catalog.fuzzy and not self.use_fuzzy:
                self.log.info(
                    'catalog %s is marked as fuzzy, skipping', po_file)
                continue
...
class extract_messages(Command):
    ...
    def run(self):
        ...
        with open(self.output_file, 'wb') as outfile:
            ...
            write_po(
                outfile, catalog, width=self.width,
...
class update_catalog(Command):
    ...
    def run(self):
        ...
        for locale, filename in po_files:
            ...
            self.log.info('updating catalog %s based on %s',
...
class CommandLineInterface:
    ...
    def run(self, argv=None):
        ...
        self.parser.add_option(
            '--list-locales', dest='list_locales',
            action='store_true',
    ...
    def _configure_command(self, cmdname, argv):
        ...
        for long, short, help in cmdclass.user_options:
            ...
            if name == as_args:
                ...
                parser.add_option(*strs, action='append',
                                  help=help, choices=choices)
            else:
                parser.add_option(*strs, help=help,
