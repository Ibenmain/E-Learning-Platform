...
def increment_argcomplete_index() -> None:
    ...
    try:
        ...
        try:
            # type:ignore[attr-defined,no-untyped-call]
            argcomplete.debug('Unable to increment $_ARGCOMPLETE',
...
class ExtendedCompletionFinder(CompletionFinder):
    ...
    def _get_completions(
        ...
        completions = super()._get_completions(comp_words, cword_prefix,
        ...
        if self.subcommands and len(comp_words) == 1:
            ...
            completions.extend(
                subc for subc in self.subcommands if subc.startswith(cword_prefix))
    ...
    def _get_option_completions(
        ...
        completions = super()._get_option_completions(
            parser, cword_prefix)  # type:ignore[no-untyped-call]
