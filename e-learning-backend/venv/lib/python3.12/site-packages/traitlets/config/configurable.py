...
from .loader import _is_section_key
from .loader import Config
from .loader import DeferredConfig
from .loader import LazyConfigValue
...
class LoggingConfigurable(Configurable):
    ...
    def _get_log_handler(self) -> logging.Handler | None:
        ...
        logger: logging.Logger = (
            self.log if isinstance(
                self.log, logging.Logger) else self.log.logger
        )
