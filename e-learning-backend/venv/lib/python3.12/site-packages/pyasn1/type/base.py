...
__all__ = [
    'Asn1Item', 'Asn1Type', 'SimpleAsn1Type',
    'ConstructedAsn1Type',
]
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            op_names = [
                ...
                for name in dir(typ)
                if (
                    name not in cls.skipMethods and
...
class SimpleAsn1Type(Asn1Type):
    ...
    def __init__(self, value=noValue, **kwargs):
        ...
        if value is noValue:
            ...
            try:
                ...
                raise type(exValue)('{} at {}'.format(exValue, self.__class__.__name__))
    ...
    def __repr__(self):
        ...
        for attr, value in self.readOnly.items():
            if value:
                representation += ', {} {}'.format(attr, value)
    ...
    def prettyPrintType(self, scope=0):
        return '{} -> {}'.format(self.tagSet, self.__class__.__name__)
...
class ConstructedAsn1Type(Asn1Type):
    ...
    def __repr__(self):
        ...
        for attr, value in self.readOnly.items():
            if value is not noValue:
                representation += ', {}={!r}'.format(attr, value)
