...
class TagSet:
    ...
    *superTags: :class:`~pyasn1.type.tag.Tag`
    ...
    def __repr__(self):
        representation = '-'.join([
            '{}:{}:{}'.format(x.tagClass, x.tagFormat, x.tagId)
        ...
        return '<{} object, {}>'.format(self.__class__.__name__, representation)
    ...
    def tagExplicitly(self, superTag):
        ...
        if superTag.tagFormat != tagFormatConstructed:
            superTag = Tag(superTag.tagClass,
                           tagFormatConstructed, superTag.tagId)
    ...
    def tagImplicitly(self, superTag):
        ...
        if self.__superTags:
            superTag = Tag(superTag.tagClass,
                           self.__superTags[-1].tagFormat, superTag.tagId)
