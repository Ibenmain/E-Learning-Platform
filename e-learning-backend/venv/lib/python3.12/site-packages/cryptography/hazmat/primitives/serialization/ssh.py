...
from cryptography.hazmat.primitives.serialization import _KeySerializationEncryption
...
def _get_ssh_key_type(
    key: SSHPrivateKeyTypes | SSHPublicKeyTypes,
) -> bytes:
...
class _FragList:
    ...
    def __init__(
        self, init: list[bytes] | None = None,
    ) -> None:
        self.flist = []
        if init:
