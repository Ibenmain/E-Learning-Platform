...
from social_core.storage import AssociationMixin
from social_core.storage import BaseStorage
from social_core.storage import CodeMixin
from social_core.storage import NonceMixin
...
class DjangoUserMixin(UserMixin):
    ...
    def create_social_auth(cls, user, uid, provider):
        ...
        if hasattr(transaction, 'atomic'):
            ...
            with transaction.atomic(using=using):
                social_auth = cls.objects.create(
