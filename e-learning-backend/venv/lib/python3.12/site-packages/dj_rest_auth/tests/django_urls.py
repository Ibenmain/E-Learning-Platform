...
urlpatterns += [
    re_path(r'^logout/custom_query/$', logout,
            dict(redirect_field_name='follow')),
    re_path(r'^logout/next_page/$', logout, dict(next_page='/somewhere/')),
    re_path(r'^logout/next_page/named/$', logout,
            dict(next_page='password_reset')),
    re_path(r'^password_reset_from_email/$', password_reset,
            dict(from_email='staffmember@example.com')),
    re_path(r'^password_reset/custom_redirect/$', password_reset,
            dict(post_reset_redirect='/custom/')),
    re_path(r'^password_reset/custom_redirect/named/$', password_reset,
    ...
    re_path(r'^password_change/custom/$', password_change,
            dict(post_change_redirect='/custom/')),
    re_path(r'^password_change/custom/named/$', password_change,
            dict(post_change_redirect='password_reset')),
    re_path(r'^admin_password_reset/$',
            password_reset, dict(is_admin_site=True)),
    re_path(r'^login_required/$', login_required(password_reset)),
    re_path(r'^login_required_login_url/$',
