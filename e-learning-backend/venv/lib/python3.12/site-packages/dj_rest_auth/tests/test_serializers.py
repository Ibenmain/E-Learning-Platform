    ...
    def test_validate_username_with_all_auth_failure(self):
        ...
        self.assertEqual(
            serializer.errors,
            {
                'username': [
                    ErrorDetail(
                        string='username must be lower case', code='invalid'),
                ],
            },
        )
...
class TestSocialLoginSerializer(TestCase):
    NO_VIEW_SUBMIT_ERROR = {'non_field_errors': [
        'View is not defined, pass it as a context variable']}
    NO_ADAPTER_CLASS_PRESENT = {
        'non_field_errors': ['Define adapter_class in view']}
    ...
    def test_validate_no_adapter_class_present(self):
        ...
        serializer = SocialLoginSerializer(data=self.request_data, context={
                                           'request': self.request, 'view': dummy_view})
        serializer.is_valid()
