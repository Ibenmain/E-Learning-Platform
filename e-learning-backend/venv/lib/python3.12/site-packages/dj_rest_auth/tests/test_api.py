...
class APIBasicTests(TestsMixin, TestCase):
    ...
    def test_login_failed_email_validation(self):
        ...
        self.assertEqual(resp.json['non_field_errors']
                         [0], 'Must include "email" and "password".')
    ...
    def test_login_failed_username_validation(self):
        ...
        resp = self.post(self.login_url, data=payload, status_code=400)
        self.assertEqual(resp.json['non_field_errors']
                         [0], 'Must include "username" and "password".')
    ...
    def test_password_change_honors_password_validators(self):
        ...
        self.post(self.password_change_url,
                  data=new_password_payload, status_code=400)
    ...
    def test_password_reset_honors_password_validators(self):
        ...
        self.post(reverse('rest_password_reset_confirm'),
    ...
    def test_registration_honors_password_validators(self):
        self.post(self.register_url,
                  data=self.REGISTRATION_DATA, status_code=400)
    ...
    def test_registration_allowed_with_custom_no_password_serializer(self):
        ...
        result = self.post(self.no_password_register_url,
    ...
    def test_blacklisting(self):
        ...
        self.post(self.logout_url, status_code=500,
    ...
    @override_api_settings(JWT_AUTH_COOKIE_ENFORCE_CSRF_ON_UNAUTHENTICATED=True)
    @override_settings(
        REST_FRAMEWORK=dict(
            DEFAULT_AUTHENTICATION_CLASSES=[
                'dj_rest_auth.jwt_auth.JWTCookieAuthentication',
    ...
    def test_refresh_cookie_name(self):
        ...
        self.assertEqual(resp.cookies.get(
            'refresh-xxx').get('path'), '/foo/bar')
    ...
    def test_rest_session_login_sets_session_cookie(self):
        ...
        with override_api_settings(SESSION_LOGIN=False):
            resp = self.post(self.login_url, data=payload, status_code=200)
            self.assertFalse(
                settings.SESSION_COOKIE_NAME in resp.cookies.keys())
