...
def _unique(
    ...
    @functools.wraps(fn)
    def unique(*args: Any, **kw: Any) -> Generator[Any]:
        seen: set[Any] = set()
...
@_unique
def uninstallation_paths(dist: BaseDistribution) -> Generator[str]:
    """
...
class UninstallPathSet:
    ...
    def add(self, path: str) -> None:
        ...
        path = os.path.join(self._normalize_path_cached(
            head), os.path.normcase(tail))
