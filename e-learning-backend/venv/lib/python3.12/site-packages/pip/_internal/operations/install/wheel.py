...
from pip._internal.utils.misc import StreamWrapper
...
def _install_wheel(  # noqa: C901, PLR0915 function is too long
    ...
    def pyc_source_file_paths() -> Generator[str]:
    ...
    def _generate_file(path: str, **kwargs: Any) -> Generator[BinaryIO]:
...
@contextlib.contextmanager
def req_error_context(req_description: str) -> Generator[None]:
    try:
        yield
