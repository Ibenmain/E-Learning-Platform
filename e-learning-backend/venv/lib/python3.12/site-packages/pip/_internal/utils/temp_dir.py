...
@contextmanager
def global_tempdir_manager() -> Generator[None]:
...
@contextmanager
def tempdir_registry() -> Generator[TempDirectoryTypeRegistry]:
    ...
    def cleanup(self) -> None:
        ...
        def onerror(
            ...
            if func in (os.unlink, os.remove, os.rmdir):
                ...
                logger.debug('%s failed with %s.',
                             func.__qualname__, formatted_exc)
...
class AdjacentTempDirectory(TempDirectory):
    ...
    @classmethod
    def _generate_names(cls, name: str) -> Generator[str]:
