...
_241_FIELDS = (
    'Metadata-Version', 'Name', 'Version', 'Platform', 'Summary', 'Description', 'Keywords', 'Home-page',
...
_345_MARKERS = (
    'Provides-Dist', 'Requires-Dist', 'Requires-Python', 'Obsoletes-Dist', 'Requires-External',
...
_426_MARKERS = ('Private-Version', 'Provides-Extra',
...
_LISTFIELDS = (
    'Platform', 'Classifier', 'Obsoletes', 'Requires', 'Provides', 'Obsoletes-Dist', 'Provides-Dist',
        ...
        for fields, controller in (
            ...
            for field in fields:
                ...
                if value is not None and not controller(value):
                    warnings.append(
                        "Wrong value for '{}': {}".format(field, value))
...
class Metadata:
        ...
        if self._legacy:
            ...
            for key in ('build', 'dev', 'test'):
                ...
                if e in extras:
                    ...
                    result.extend(self.get_requirements(
    ...
    def write(self, path=None, fileobj=None, legacy=False, skip_unknown=True):
        ...
        if legacy:
            ...
            if self._legacy:
                ...
                d = self._data
            if fileobj:
                json.dump(d, fileobj, ensure_ascii=True,
    ...
    def __repr__(self):
        ...
        return '<{} {} {} ({})>'.format(self.__class__.__name__, self.metadata_version, name, version)
