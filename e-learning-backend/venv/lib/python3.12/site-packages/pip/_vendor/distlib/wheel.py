...
from .util import get_cache_base
...
class Wheel:
    ...
    def filename(self):
        ...
        return '{}-{}{}-{}-{}-{}.whl'.format(self.name, version, buildver, pyver, abi, arch)
    ...
    def _get_dylib_cache(self):
        ...
        if cache is None:
            ...
            base = os.path.join(get_cache_base(), 'dylib-cache',
                ...
                if abi != 'none' and sys.platform.startswith('linux'):
                    ...
                    if len(parts) == 2:
                        ...
                        result.append((
                            ''.join(
                                (IMP_PREFIX, version),
                            ), abi, 'manylinux_{}_{}_{}'.format(parts[0], parts[1], arch),
                        ))
