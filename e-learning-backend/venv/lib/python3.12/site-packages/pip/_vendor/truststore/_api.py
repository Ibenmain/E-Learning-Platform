...
from ._ssl_constants import _original_SSLContext
from ._ssl_constants import _original_super_SSLContext
from ._ssl_constants import _truststore_SSLContext_dunder_class
from ._ssl_constants import _truststore_SSLContext_super_class
...
if sys.version_info >= (3, 13):
    ...
    def _get_unverified_chain_bytes(sslobj: ssl.SSLObject) -> list[bytes]:
        ...
        return [
            cert if isinstance(cert, bytes) else cert.public_bytes(
                _ssl.ENCODING_DER)
