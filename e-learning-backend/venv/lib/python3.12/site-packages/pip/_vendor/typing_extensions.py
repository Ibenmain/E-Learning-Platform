    ...
    class _SpecialGenericAlias(_special_generic_alias_base, _root=True):
        ...
        def __getitem__(self, params):
            ...
            if (
                ...
                params = (
                    *params, *self._defaults[len(params) - self._nparams:])
...
# 3.8-3.9
    ...
    def get_origin(tp):
        ...
        if isinstance(
            tp, (
                typing._GenericAlias, _typing_GenericAlias, _BaseGenericAlias,
...
if _PEP_696_IMPLEMENTED:
    ...
    class TypeVar(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(
            cls, name, *constraints, bound=None,
        ...
        if alen != elen:
            ...
            if hasattr(cls, '__parameters__'):
                ...
                if alen < elen:
                    ...
                    num_default_tv = sum(
                        getattr(p, '__default__', NoDefault)
