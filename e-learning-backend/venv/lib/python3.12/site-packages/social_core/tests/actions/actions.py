...
from ...actions import do_auth
from ...actions import do_complete
from ...utils import module_member
from ...utils import parse_qs
from ..models import TestAssociation
from ..models import TestNonce
from ..models import TestStorage
from ..models import TestUserSocialAuth
...
class BaseActionTest(unittest.TestCase):
    ...
    def do_login(
        ...
        HTTPretty.register_uri(HTTPretty.GET, location_url,
    ...
    def do_login_with_partial_pipeline(self, before_complete=None):
        ...
        HTTPretty.register_uri(HTTPretty.GET, redirect.url,
                               status=200, body='foobar')
        ...
        if before_complete:
            before_complete()
        redirect = do_complete(self.backend, user=self.user, login=_login)
        self.assertEqual(self.strategy.session_get(
