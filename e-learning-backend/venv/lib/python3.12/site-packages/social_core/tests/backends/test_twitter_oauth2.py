...
class TwitterOAuth2Mixin:
    ...
    def test_login(self):
        ...
        self.assertEqual(
            social.extra_data['created_at'], '2023-03-06T06:18:59.000Z')
        ...
        self.assertEqual(
            social.extra_data['url'], 'https://social-core-test-url.com')
        self.assertEqual(
            social.extra_data['pinned_tweet_id'], '9876543210987654321')
        self.assertEqual(
            social.extra_data['profile_image_url'],
            'https://social-core-test-url.com/image.png',
        )
        self.assertEqual(
            social.extra_data['public_metrics']['followers_count'], 69)
        self.assertEqual(
            social.extra_data['public_metrics']['following_count'], 129)
        self.assertEqual(
            social.extra_data['public_metrics']['tweet_count'], 40)
        self.assertEqual(
            social.extra_data['public_metrics']['listed_count'], 7)
