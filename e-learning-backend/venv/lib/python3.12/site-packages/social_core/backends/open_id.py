...
from openid.consumer.consumer import CANCEL
from openid.consumer.consumer import Consumer
from openid.consumer.consumer import FAILURE
...
SREG_ATTR = [('email', 'email'), ('fullname', 'fullname'),
             ('nickname', 'nickname')]
...
class OpenIdAuth(BaseAuth):
    ...
    def continue_pipeline(self, partial):
        ...
        response = self.consumer().complete(
            dict(self.data.items()), self.strategy.absolute_uri(
                self.redirect_uri),
        )
