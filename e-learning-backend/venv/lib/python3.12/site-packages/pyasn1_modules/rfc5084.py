...
AES_CCM_ICVlen.subtypeSpec = constraint.SingleValueConstraint(
    4, 6, 8, 10, 12, 14, 16)
...
CCMParameters.componentType = namedtype.NamedTypes(
    namedtype.NamedType('aes-nonce', univ.OctetString().subtype(
        subtypeSpec=constraint.ValueSizeConstraint(7, 13))),
    ...
    namedtype.DefaultedNamedType(
        'aes-ICVlen', AES_CCM_ICVlen().subtype(value=12)),
)
...
GCMParameters.componentType = namedtype.NamedTypes(
    ...
    namedtype.DefaultedNamedType(
        'aes-ICVlen', AES_GCM_ICVlen().subtype(value=12)),
)
