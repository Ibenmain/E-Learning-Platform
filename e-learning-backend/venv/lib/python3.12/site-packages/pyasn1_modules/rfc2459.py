...
class X520countryName(char.PrintableString):
    subtypeSpec = char.PrintableString.subtypeSpec + \
...
class Pkcs9email(char.IA5String):
    subtypeSpec = char.IA5String.subtypeSpec + \
        constraint.ValueSizeConstraint(1, ub_emailaddress_length)
...
class TerminalType(univ.Integer):
    subtypeSpec = univ.Integer.subtypeSpec + \
        constraint.ValueSizeConstraint(0, ub_integer_options)
...
class PDSName(char.PrintableString):
    subtypeSpec = char.PrintableString.subtypeSpec + \
        constraint.ValueSizeConstraint(1, ub_pds_name_length)
...
class TeletexOrganizationalUnitName(char.TeletexString):
    subtypeSpec = char.TeletexString.subtypeSpec + \
...
class TeletexCommonName(char.TeletexString):
    subtypeSpec = char.TeletexString.subtypeSpec + \
        constraint.ValueSizeConstraint(1, ub_common_name_length)
...
class CRLNumber(univ.Integer):
    subtypeSpec = univ.Integer.subtypeSpec + \
        constraint.ValueSizeConstraint(0, MAX)
...
class PolicyConstraints(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.OptionalNamedType(
            'requireExplicitPolicy', SkipCerts().subtype(
                implicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatConstructed, 0),
            ),
        ),
        namedtype.OptionalNamedType(
            'inhibitPolicyMapping', SkipCerts().subtype(
                implicitTag=tag.Tag(tag.tagClassContext,
...
class BaseDistance(univ.Integer):
    subtypeSpec = univ.Integer.subtypeSpec + \
        constraint.ValueRangeConstraint(0, MAX)
...
class PolicyInformation(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            'policyQualifiers', univ.SequenceOf(componentType=PolicyQualifierInfo()).subtype(
                subtypeSpec=constraint.ValueSizeConstraint(1, MAX),
            ),
        ),
    )
...
class GeneralName(univ.Choice):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            'iPAddress', univ.OctetString().subtype(
                implicitTag=tag.Tag(tag.tagClassContext,
...
class IssuingDistributionPoint(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            'onlyContainsUserCerts', univ.Boolean(False).subtype(
                implicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 1),
            ),
        ),
        namedtype.NamedType(
            'onlyContainsCACerts', univ.Boolean(False).subtype(
                implicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 2),
            ),
        ),
        ...
        namedtype.NamedType(
            'indirectCRL', univ.Boolean(False).subtype(
                implicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 4),
            ),
        ),
...
class GeneralSubtree(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.DefaultedNamedType(
            'minimum', BaseDistance(0).subtype(
                implicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatConstructed, 0),
            ),
        ),
...
class TBSCertList(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType('revokedCertificates', univ.SequenceOf(
            componentType=RevokedCertificate())),
        namedtype.OptionalNamedType(
            'crlExtensions', Extensions().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatConstructed, 0),
            ),
        ),
