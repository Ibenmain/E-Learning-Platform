...
HardwareModules.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        'hwSerialEntries', univ.SequenceOf(
            componentType=HardwareSerialEntry(),
        ).subtype(
...
HardwareModuleIdentifierList.subtypeSpec = constraint.ValueSizeConstraint(
    1, MAX)
...
TargetIdentifier.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'hwModules', HardwareModuleIdentifierList().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1),
        ),
    ),
    namedtype.NamedType(
        'communities', CommunityIdentifierList().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2),
        ),
    ),
    namedtype.NamedType(
        'allModules', univ.Null().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3),
        ),
    ),
    namedtype.NamedType(
        'uri', char.IA5String().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 4),
        ),
    ),
    namedtype.NamedType(
        'otherName', AnotherName().subtype(
...
StatusResponse.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'terseResponse', TerseStatusResponse().subtype(
            implicitTag=tag.Tag(tag.tagClassContext,
                                tag.tagFormatConstructed, 0),
        ),
    ),
    namedtype.NamedType(
        'verboseResponse', VerboseStatusResponse().subtype(
            implicitTag=tag.Tag(tag.tagClassContext,
...
TBSCertificateChangeInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        'signature', AlgorithmIdentifier().subtype(
    ...
    namedtype.OptionalNamedType(
        'validity', Validity().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2),
        ),
    ),
    namedtype.OptionalNamedType(
        'subject', Name().subtype(
            implicitTag=tag.Tag(
    ...
    namedtype.NamedType(
        'subjectPublicKeyInfo', SubjectPublicKeyInfo().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 4),
        ),
    ),
    namedtype.OptionalNamedType(
        'exts', Extensions().subtype(
            explicitTag=tag.Tag(
...
TrustAnchorChangeInfoChoice.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'tbsCertChange', TBSCertificateChangeInfo().subtype(
            implicitTag=tag.Tag(tag.tagClassContext,
                                tag.tagFormatConstructed, 0),
        ),
    ),
    namedtype.NamedType(
        'taChange', TrustAnchorChangeInfo().subtype(
            implicitTag=tag.Tag(tag.tagClassContext,
                                tag.tagFormatConstructed, 1),
        ),
    ),
...
TrustAnchorUpdate.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'add', TrustAnchorChoice().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1),
        ),
    ),
    namedtype.NamedType(
        'remove', SubjectPublicKeyInfo().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2),
        ),
    ),
    namedtype.NamedType(
        'change', TrustAnchorChangeInfoChoice().subtype(
...
UpdateConfirm.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'terseConfirm', TerseUpdateConfirm().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0),
        ),
    ),
    namedtype.NamedType(
        'verboseConfirm', VerboseUpdateConfirm().subtype(
            implicitTag=tag.Tag(tag.tagClassContext,
                                tag.tagFormatConstructed, 1),
        ),
    ),
...
ApexUpdateConfirm.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'terseApexConfirm',
        TerseApexUpdateConfirm().subtype(
            implicitTag=tag.Tag(
                tag.tagClassContext,
                tag.tagFormatSimple, 0,
            ),
    ...
    namedtype.NamedType(
        'verboseApexConfirm',
        VerboseApexUpdateConfirm().subtype(
            implicitTag=tag.Tag(
                tag.tagClassContext,
                tag.tagFormatConstructed, 1,
            ),
...
CommunityConfirm.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        'verboseCommConfirm',
        VerboseCommunityConfirm().subtype(
            implicitTag=tag.Tag(
                tag.tagClassContext,
                tag.tagFormatConstructed, 1,
            ),
