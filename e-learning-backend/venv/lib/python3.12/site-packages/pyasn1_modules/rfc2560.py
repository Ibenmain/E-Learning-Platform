...
id_pkix_ocsp_archive_cutoff = univ.ObjectIdentifier(
    (1, 3, 6, 1, 5, 5, 7, 48, 1, 6))
id_pkix_ocsp_service_locator = univ.ObjectIdentifier(
...
class RevokedInfo(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            'revocationReason', CRLReason().subtype(
...
class CertStatus(univ.Choice):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            'revoked',
            RevokedInfo().subtype(implicitTag=tag.Tag(
                tag.tagClassContext, tag.tagFormatSimple, 1)),
        ),
        namedtype.NamedType(
            'unknown',
            UnknownInfo().subtype(implicitTag=tag.Tag(
...
class SingleResponse(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            'nextUpdate', useful.GeneralizedTime().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 0),
            ),
        ),
        namedtype.OptionalNamedType(
            'singleExtensions', rfc2459.Extensions().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
...
class ResponderID(univ.Choice):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            'byName',
            rfc2459.Name().subtype(explicitTag=tag.Tag(
                tag.tagClassContext, tag.tagFormatSimple, 1)),
        ),
        namedtype.NamedType(
            'byKey',
...
class ResponseData(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            'responseExtensions', rfc2459.Extensions().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 1),
            ),
        ),
...
class OCSPResponse(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            'responseBytes', ResponseBytes().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 0),
            ),
        ),
...
class Request(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            'singleRequestExtensions', rfc2459.Extensions().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 0),
            ),
        ),
...
class TBSRequest(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            'requestorName', GeneralName().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 1),
            ),
        ),
        ...
        namedtype.OptionalNamedType(
            'requestExtensions', rfc2459.Extensions().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
