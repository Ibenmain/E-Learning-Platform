...
ChallengeFormat.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        'min', univ.Integer().subtype(
            subtypeSpec=constraint.ValueRangeConstraint(0, MAX),
        ),
    ),
    namedtype.NamedType(
        'max', univ.Integer().subtype(
            subtypeSpec=constraint.ValueRangeConstraint(0, MAX),
        ),
    ),
)
...
PSKCAlgorithmParameters.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        'challengeFormat', ChallengeFormat().subtype(
            implicitTag=tag.Tag(tag.tagClassContext,
                                tag.tagFormatConstructed, 0),
        ),
    ),
    namedtype.NamedType(
        'responseFormat', ResponseFormat().subtype(
            implicitTag=tag.Tag(tag.tagClassContext,
...
at_pskc_numberOfTransactions.subtypeSpec = constraint.ValueRangeConstraint(
    0, MAX)
...
PINPolicy.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        'pinKeyId', char.UTF8String().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0),
        ),
    ),
    namedtype.NamedType(
        'pinUsageMode', PINUsageMode().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1),
        ),
    ),
    namedtype.OptionalNamedType(
        'maxFailedAttempts', univ.Integer().subtype(
            subtypeSpec=constraint.ValueRangeConstraint(0, MAX),
        ).subtype(
    ...
    namedtype.OptionalNamedType(
        'minLength', univ.Integer().subtype(
            subtypeSpec=constraint.ValueRangeConstraint(0, MAX),
        ).subtype(
    ...
    namedtype.OptionalNamedType(
        'maxLength', univ.Integer().subtype(
            subtypeSpec=constraint.ValueRangeConstraint(0, MAX),
        ).subtype(
...
OneSymmetricKey.sizeSpec = univ.Sequence.sizeSpec + \
...
SymmetricKeyPackage.componentType = namedtype.NamedTypes(
    namedtype.DefaultedNamedType(
        'version', KeyPkgVersion().subtype(value='v1')),
    namedtype.OptionalNamedType(
        'sKeyPkgAttrs',
