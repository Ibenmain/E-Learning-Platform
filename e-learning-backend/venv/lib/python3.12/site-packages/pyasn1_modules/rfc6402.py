            ...
            componentType=namedtype.NamedTypes(
                ...
                namedtype.NamedType(
                    'extendedFailInfo', univ.Sequence(
                        componentType=namedtype.NamedTypes(
                            namedtype.NamedType(
                                'failInfoOID', univ.ObjectIdentifier()),
                            namedtype.NamedType(
...
TaggedRequest.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'tcr', TaggedCertificationRequest().subtype(
    ...
    namedtype.NamedType(
        'crm',
        rfc4211.CertReqMsg().subtype(implicitTag=tag.Tag(
...
PKIData.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType('otherMsgSequence',
                        univ.SequenceOf(componentType=OtherMsg())),
)
...
LraPopWitness.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType('bodyIds', univ.SequenceOf(
        componentType=BodyPartID())),
)
