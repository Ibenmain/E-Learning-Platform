...
class SingleResponse(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            'singleExtensions', Extensions().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
...
class ResponseData(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            'responses', univ.SequenceOf(
                componentType=SingleResponse(),
            ),
        ),
        namedtype.OptionalNamedType(
            'responseExtensions', Extensions().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 1),
            ),
        ),
...
class Request(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            'singleRequestExtensions', Extensions().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 0),
            ),
        ),
...
class TBSRequest(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            'requestList', univ.SequenceOf(
                componentType=Request(),
            ),
        ),
        namedtype.OptionalNamedType(
            'requestExtensions', Extensions().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 2),
            ),
        ),
...
class CrlID(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.OptionalNamedType(
            'crlUrl', char.IA5String().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 0),
            ),
        ),
        namedtype.OptionalNamedType(
            'crlNum', univ.Integer().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 1),
            ),
        ),
        namedtype.OptionalNamedType(
            'crlTime', useful.GeneralizedTime().subtype(
                explicitTag=tag.Tag(tag.tagClassContext,
                                    tag.tagFormatSimple, 2),
            ),
        ),
