...
IPAddressChoice.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        'addressesOrRanges', univ.SequenceOf(
...
IPAddressFamily.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'addressFamily', univ.OctetString().subtype(
...
ASIdentifiers.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        'asnum', ASIdentifierChoice().subtype(
            explicitTag=tag.Tag(
                tag.tagClassContext,
    ...
    namedtype.OptionalNamedType(
        'rdi', ASIdentifierChoice().subtype(
            explicitTag=tag.Tag(
                tag.tagClassContext,
