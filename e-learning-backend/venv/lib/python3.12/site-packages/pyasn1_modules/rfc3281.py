...
ObjectDigestInfo.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'digestedObjectType', univ.Enumerated(
...
Target.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'targetName', rfc3280.GeneralName().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0),
        ),
    ),
    namedtype.NamedType(
        'targetGroup', rfc3280.GeneralName().subtype(
...
Clearance.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'policyId', univ.ObjectIdentifier().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0),
        ),
    ),
    ...
    namedtype.OptionalNamedType(
        'securityCategories', univ.SetOf(componentType=SecurityCategory()).subtype(
...
AAControls.componentType = namedtype.NamedTypes(
    ...
    namedtype.DefaultedNamedType(
        'permitUnSpecified', univ.Boolean().subtype(value=1)),
)
...
V2Form.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        'baseCertificateID', IssuerSerial().subtype(
            implicitTag=tag.Tag(tag.tagClassContext,
                                tag.tagFormatConstructed, 0),
        ),
    ),
    namedtype.OptionalNamedType(
        'objectDigestInfo', ObjectDigestInfo().subtype(
            implicitTag=tag.Tag(tag.tagClassContext,
...
Holder.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        'entityName', rfc3280.GeneralNames().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1),
        ),
    ),
    namedtype.OptionalNamedType(
...
RoleSyntax.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        'roleAuthority', rfc3280.GeneralNames().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0),
        ),
    ),
    namedtype.NamedType(
        'roleName',
        rfc3280.GeneralName().subtype(implicitTag=tag.Tag(
...
IetfAttrSyntax.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        'policyAuthority', rfc3280.GeneralNames().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
    namedtype.NamedType(
