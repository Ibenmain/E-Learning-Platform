...
Gost28147_89_EncryptedKey.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        'maskKey', Gost28147_89_Key().subtype(
...
GostR3410_2001_CertificateSignature.subtypeSpec = constraint.ValueSizeConstraint(
    256, 512)
...
GostR3410_2001_PublicKeyParameters.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'publicKeyParamSet', univ.ObjectIdentifier().subtype(
    ...
    namedtype.NamedType(
        'digestParamSet', univ.ObjectIdentifier().subtype(
            subtypeSpec=constraint.SingleValueConstraint(
    ...
    namedtype.DefaultedNamedType(
        'encryptionParamSet',
        Gost28147_89_ParamSet().subtype(
            value=id_Gost28147_89_CryptoPro_A_ParamSet,
        ),
    ),
)
...
GostR3410_94_CertificateSignature.subtypeSpec = constraint.ValueSizeConstraint(
    256, 512)
...
GostR3410_94_ParamSetParameters_t.subtypeSpec = constraint.SingleValueConstraint(
    512, 1024)
...
GostR3410_94_ValidationBisParameters_c.subtypeSpec = constraint.ValueRangeConstraint(
    0, 4294967295)
...
GostR3410_94_ValidationParameters_c.subtypeSpec = constraint.ValueRangeConstraint(
    0, 65535)
