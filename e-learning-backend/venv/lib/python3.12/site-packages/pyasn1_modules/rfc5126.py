...
class SigPolicyQualifierInfo(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            'sigQualifier', univ.Any(),
            openType=opentype.OpenType(
                'sigPolicyQualifierId', sigQualifiersMap),
        ),
    )
...
class SignaturePolicy(univ.Choice):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType('signaturePolicyImplied',
...
class DisplayText(univ.Choice):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            'visibleString', char.VisibleString().subtype(
...
id_aa_signatureTimeStampToken = univ.ObjectIdentifier(
...
id_aa_ets_contentTimestamp = univ.ObjectIdentifier(
...
id_aa_ets_revocationValues = univ.ObjectIdentifier(
...
id_aa_ets_certCRLTimestamp = univ.ObjectIdentifier(
...
id_aa_ets_archiveTimestampV2 = univ.ObjectIdentifier(
...
id_aa_ets_attrCertificateRefs = univ.ObjectIdentifier(
...
id_aa_ets_attrRevocationRefs = univ.ObjectIdentifier(
