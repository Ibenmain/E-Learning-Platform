...
KeyAlgorithm.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        'checkWordAlg', univ.ObjectIdentifier().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1),
        ),
    ),
    namedtype.OptionalNamedType(
        'crcAlg', univ.ObjectIdentifier().subtype(
...
KeyPkgReceiver.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'sirEntity', SIREntityName().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0),
        ),
    ),
    namedtype.NamedType(
        'community', CommunityIdentifier().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1),
        ),
    ),
)
...
EditionID.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'char', univ.Choice(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType(
                    'charEdition', CharEdition().subtype(
                        implicitTag=tag.Tag(
                            tag.tagClassContext, tag.tagFormatSimple, 1),
                    ),
                ),
                namedtype.NamedType(
                    'charEditionRange', CharEditionRange().subtype(
                        implicitTag=tag.Tag(
    ...
    namedtype.NamedType(
        'num', univ.Choice(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType(
                    'numEdition', NumEdition().subtype(
                        implicitTag=tag.Tag(
                            tag.tagClassContext, tag.tagFormatSimple, 3),
                    ),
                ),
                namedtype.NamedType(
                    'numEditionRange', NumEditionRange().subtype(
                        implicitTag=tag.Tag(
...
RegisterID.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        'registerRange', RegisterRange().subtype(
...
SegmentID.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'segmentNumber', SegmentNumber().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 7),
        ),
    ),
    namedtype.NamedType(
        'segmentRange', SegmentRange().subtype(
            implicitTag=tag.Tag(tag.tagClassContext,
...
KeyDistPeriod.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        'doNotDistBefore', BinaryTime().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0),
        ),
    ),
...
KeyDuration.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'hours', univ.Integer().subtype(
            subtypeSpec=constraint.ValueRangeConstraint(
                1, ub_KeyDuration_hours),
        ).subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0),
        ),
    ),
    namedtype.NamedType(
        'days', univ.Integer().subtype(
            subtypeSpec=constraint.ValueRangeConstraint(
                1, ub_KeyDuration_days),
        ),
    ),
    namedtype.NamedType(
        'weeks', univ.Integer().subtype(
            subtypeSpec=constraint.ValueRangeConstraint(
                1, ub_KeyDuration_weeks),
        ).subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1),
        ),
    ),
    namedtype.NamedType(
        'months', univ.Integer().subtype(
            subtypeSpec=constraint.ValueRangeConstraint(
                1, ub_KeyDuration_months),
        ).subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2),
        ),
    ),
    namedtype.NamedType(
        'years', univ.Integer().subtype(
            subtypeSpec=constraint.ValueRangeConstraint(
                1, ub_KeyDuration_years),
        ).subtype(
...
id_enumeratedPermissiveAttributes = univ.ObjectIdentifier(
    '2.16.840.1.101.2.1.8.3.1')

id_enumeratedRestrictiveAttributes = univ.ObjectIdentifier(
...
EnumeratedTag.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType('attributeList', univ.SetOf(
        componentType=SecurityAttribute())),
)
...
FreeFormField.componentType = namedtype.NamedTypes(
    namedtype.NamedType('bitSetAttributes', univ.BitString()
                        ),  # Not permitted in RFC 7906
    namedtype.NamedType('securityAttributes', univ.SetOf(
        componentType=SecurityAttribute())),
)
...
id_unrecognizedSecurityPolicy = univ.ObjectIdentifier(
