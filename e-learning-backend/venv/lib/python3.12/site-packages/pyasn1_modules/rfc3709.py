...
LogotypeDetails.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        'logotypeHash', univ.SequenceOf(
            componentType=HashAlgAndValue(),
        ).subtype(
            sizeSpec=constraint.ValueSizeConstraint(1, MAX),
        ),
    ),
    namedtype.NamedType(
        'logotypeURI', univ.SequenceOf(
...
LogotypeAudioInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        'sampleRate', univ.Integer().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3),
        ),
    ),
    namedtype.OptionalNamedType(
        'language', char.IA5String().subtype(
...
LogotypeImageInfo.componentType = namedtype.NamedTypes(
    namedtype.DefaultedNamedType(
        'type', LogotypeImageType().subtype(
            implicitTag=tag.Tag(
                tag.tagClassContext,
...
LogotypeData.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        'image', univ.SequenceOf(
            componentType=LogotypeImage(),
        ),
    ),
    namedtype.OptionalNamedType(
        'audio', univ.SequenceOf(
...
LogotypeInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        'indirect', LogotypeReference().subtype(
            implicitTag=tag.Tag(
                tag.tagClassContext,
...
LogotypeExtn.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        'communityLogos', univ.SequenceOf(
    ...
    namedtype.OptionalNamedType(
        'issuerLogo', LogotypeInfo().subtype(
            explicitTag=tag.Tag(tag.tagClassContext,
                                tag.tagFormatConstructed, 1),
        ),
    ),
    namedtype.OptionalNamedType(
        'subjectLogo', LogotypeInfo().subtype(
            explicitTag=tag.Tag(tag.tagClassContext,
                                tag.tagFormatConstructed, 2),
        ),
    ),
    namedtype.OptionalNamedType(
        'otherLogos', univ.SequenceOf(
            componentType=OtherLogotypeInfo(),
        ).subtype(
            explicitTag=tag.Tag(
