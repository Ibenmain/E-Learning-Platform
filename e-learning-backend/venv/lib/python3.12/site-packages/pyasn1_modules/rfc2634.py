...
SigningCertificate.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'certs', univ.SequenceOf(
            componentType=ESSCertID(),
        ),
    ),
    namedtype.OptionalNamedType(
        'policies', univ.SequenceOf(
...
MLReceiptPolicy.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        'insteadOf', univ.SequenceOf(
            componentType=GeneralNames(),
        ).subtype(
...
MLExpansionHistory.sizeSpec = constraint.ValueSizeConstraint(
    1, ub_ml_expansion_history)
...
ESSPrivacyMark.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'pString', char.PrintableString().subtype(
            subtypeSpec=constraint.ValueSizeConstraint(
                1, ub_privacy_mark_length),
        ),
    ),
    namedtype.NamedType(
...
SecurityClassification.subtypeSpec = constraint.ValueRangeConstraint(
    0, ub_integer_options)
...
SecurityCategory.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'type', univ.ObjectIdentifier().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0),
        ),
    ),
    namedtype.NamedType(
        'value', univ.Any().subtype(
            implicitTag=tag.Tag(
...
SecurityCategories.sizeSpec = constraint.ValueSizeConstraint(
    1, ub_security_categories)
...
ESSSecurityLabel.componentType = namedtype.NamedTypes(
    namedtype.NamedType('security-policy-identifier',
...
ContentHints.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType('contentDescription', char.UTF8String().subtype(
        subtypeSpec=constraint.ValueSizeConstraint(1, MAX))),
    namedtype.NamedType('contentType', ContentType()),
)
...
ReceiptsFrom.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        'allOrFirstTier', AllOrFirstTier().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0),
        ),
    ),
    namedtype.NamedType(
        'receiptList', univ.SequenceOf(
            componentType=GeneralNames(),
        ).subtype(
            implicitTag=tag.Tag(
                tag.tagClassContext, tag.tagFormatSimple, 1,
...
ReceiptRequest.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType('receiptsTo', univ.SequenceOf(componentType=GeneralNames(
    )).subtype(sizeSpec=constraint.ValueSizeConstraint(1, ub_receiptsTo))),
)
