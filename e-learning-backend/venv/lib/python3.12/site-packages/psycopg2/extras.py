...
from psycopg2._json import register_json
from psycopg2._psycopg import REPLICATION_LOGICAL
from psycopg2._psycopg import REPLICATION_PHYSICAL
...
from psycopg2._range import RangeAdapter
from psycopg2._range import RangeCaster
...
class RealDictConnection(_connection):
    ...
    def cursor(self, *args, **kwargs):
        kwargs.setdefault('cursor_factory',
                          self.cursor_factory or RealDictCursor)
        return super().cursor(*args, **kwargs)
...
class NamedTupleConnection(_connection):
    ...
    def cursor(self, *args, **kwargs):
        kwargs.setdefault('cursor_factory',
                          self.cursor_factory or NamedTupleCursor)
        return super().cursor(*args, **kwargs)
...
class LoggingConnection(_connection):
    ...
    def cursor(self, *args, **kwargs):
        self._check()
        kwargs.setdefault('cursor_factory',
                          self.cursor_factory or LoggingCursor)
        return super().cursor(*args, **kwargs)
...
""")
        ...
        if (
            conn_status != _ext.STATUS_IN_TRANSACTION
...
def register_hstore(
    conn_or_curs, globally=False, unicode=False,
...
def register_composite(name, conn_or_curs, globally=False, factory=None):
    ...
    _ext.register_type(caster.typecaster,
