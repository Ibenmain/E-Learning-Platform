...
from oauthlib.oauth2.rfc6749.endpoints import IntrospectEndpoint
...
from ..grant_types import HybridGrant
from ..grant_types import ImplicitGrant
from ..grant_types.dispatchers import AuthorizationCodeGrantDispatcher
from ..grant_types.dispatchers import AuthorizationTokenGrantDispatcher
from ..grant_types.dispatchers import ImplicitTokenGrantDispatcher
from ..tokens import JWTToken
from .userinfo import UserInfoEndpoint


class Server(
    AuthorizationEndpoint, IntrospectEndpoint, TokenEndpoint,
    ...
    def __init__(
        self, request_validator, token_expires_in=None,
