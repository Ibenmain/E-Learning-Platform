...
from oauthlib.common import add_params_to_qs
...
class BearerToken(TokenBase):
    ...
    def __init__(
        self, request_validator=None, token_generator=None,
