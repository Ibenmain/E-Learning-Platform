...
class Client:
    ...
    def prepare_token_request(
        self, token_url, authorization_response=None,
    ...
    def prepare_refresh_token_request(
        self, token_url, refresh_token=None,
    ...
    def prepare_refresh_body(self, body='', refresh_token=None, scope=None, **kwargs):
        ...
        return prepare_token_request(
            self.refresh_token_key, body=body, scope=scope,
