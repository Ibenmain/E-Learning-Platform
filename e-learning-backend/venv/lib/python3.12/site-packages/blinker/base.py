...
if t.TYPE_CHECKING:
    ...
    AsyncWrapperType = t.Callable[[
        t.Callable[P, t.Awaitable[T]]], t.Callable[P, T]]
    SyncWrapperType = t.Callable[[t.Callable[P, T]],
...
class Signal:
    ...
    def __init__(self, doc: str | None = None) -> None:
        ...
        self.receivers: dict[IdentityType,
                             t.Callable | annotatable_weakref] = {}
        self.is_muted = False
