...
class TestSeed:
    ...
    def test_invalid_array_shape(self):
        # gh-9832
        assert_raises(
            ValueError, np.random.RandomState,
...
class TestMultinomial:
    ...
    def test_size(self):
        ...
        assert_equal(np.random.multinomial(1, p, (2, 2)).shape, (2, 2, 2))
        assert_equal(
            np.random.multinomial(1, p, np.array((2, 2))).shape,
            (2, 2, 2),
        )

        assert_raises(
            TypeError, np.random.multinomial, 1, p,
            float(1),
        )
...
class TestRandomDist:
    ...
    def test_choice_return_shape(self):
        ...
        assert_equal(
            np.random.choice(['a', 'b'], size=(3, 0, 4)).shape,
            (3, 0, 4),
        )
    ...
    def test_shuffle_untyped_warning(self, random):
        ...
        with pytest.warns(
            UserWarning,
            match="you are shuffling a 'dict' object",
        ) as rec:
    ...
    def test_scalar_exception_propagation(self):
        ...
        assert_raises(
            TypeError, np.random.uniform, throwing_float,
            throwing_float,
        )
...
class TestSingleEltArrayInput:
    ...
    def test_one_arg_funcs(self):
        funcs = (
            np.random.exponential, np.random.standard_gamma,
    ...
    def test_three_arg_funcs(self):
        funcs = [
            np.random.noncentral_f, np.random.triangular,
