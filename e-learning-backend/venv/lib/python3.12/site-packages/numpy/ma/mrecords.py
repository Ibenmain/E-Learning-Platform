    ...
    def __new__(
        ...
        **options,
        ...
        self = np.recarray.__new__(
            cls, shape, dtype=dtype, buf=buf, offset=offset,
    ...
    def __array_finalize__(self, obj):
        ...
        if _mask is None:
            ...
            if objmask is ma.nomask:
                ...
                _mask = np.array(
                    [tuple([m] * len(mdescr)) for m in objmask],
                    dtype=mdescr,
                ).view(np.recarray)
    ...
    def __getattribute__(self, attr):
        ...
        if obj.dtype.names is not None:
            raise NotImplementedError(
                'MaskedRecords is currently limited to'
                'simple records.',
            )
...
def fromrecords(
    ...
    mrec = np.rec.fromrecords(
        reclist, dtype=dtype, shape=shape, formats=formats,
...
def fromtextfile(
    ...
    *, delimitor=np._NoValue,
    ...
    _variables = ma.masked_array([
        line.strip().split(delimiter) for line in ftext
