...
from .core import filled
from .core import getmask
from .core import mask_or
from .core import masked
from .core import masked_array
from .core import nomask
...
def fail_if_array_equal(x, y, err_msg='', verbose=True):
    ...
    assert_array_compare(
        compare, x, y, err_msg=err_msg, verbose=verbose,
        header='Arrays are not equal',
    )
