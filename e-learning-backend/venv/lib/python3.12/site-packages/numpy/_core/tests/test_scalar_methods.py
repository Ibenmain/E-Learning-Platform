...
class TestAsIntegerRatio:
    ...
    @pytest.mark.parametrize(
        'ftype, frac_vals, exp_vals', [
            ...
            (
                np.half, [
                    0.0, 0.01154830649280303, 0.31082276347447274,
            ...
            (
                np.single, [
                    0.0, 0.09248576989263226, 0.8160498218131407,
            ...
            (
                np.double, [
                    0.0, 0.031066908499895136, 0.5214135908877832,
...
class TestDevice:
    ...
    """
    scalars = [
        np.bool(True), np.int64(1), np.uint64(1), np.float64(1.0),
        np.complex128(1+1j),
    ]
