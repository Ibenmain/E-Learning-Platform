...
class TestMethods:
    ...
    @pytest.mark.parametrize(
        'a,sub,start,end,out', [
            ...
            pytest.param(
                30000*'a' + 100*'b', 100*'b', 0, None, 30000,
                id='30000*a+100*b-100*b-0-None-30000',
            ),
            pytest.param(
                30000*'a', 100*'b', 0, None, -1,
                id='30000*a-100*b-0-None--1',
            ),
            pytest.param(
                15000*'a' + 15000*'b', 15000*'b', 0, None, 15000,
                id='15000*a+15000*b-15000*b-0-None-15000',
            ),
            pytest.param(
                15000*'a' + 15000*'b', 15000*'c', 0, None, -1,
    ...
    @pytest.mark.parametrize(
        'a,sub,start,end,out', [
            ...
            pytest.param(
                30000*'a' + 100*'b', 100*'b', 0, None, 1,
                id='30000*a+100*b-100*b-0-None-1',
            ),
            pytest.param(
                30000*'a', 100*'b', 0, None, 0,
                id='30000*a-100*b-0-None-0',
            ),
            pytest.param(
                30000*'a' + 100*'ab', 'ab', 0, None, 100,
                id='30000*a+100*ab-ab-0-None-100',
            ),
            pytest.param(
                15000*'a' + 15000*'b', 15000*'b', 0, None, 1,
                id='15000*a+15000*b-15000*b-0-None-1',
            ),
            pytest.param(
                15000*'a' + 15000*'b', 15000*'c', 0, None, 0,
...
class TestMethodsWithUnicode:
    ...
    @pytest.mark.parametrize(
        'in_', [
            ...
            '\U000104A0',
            pytest.param(
                '\U0001F107', marks=pytest.mark.xfail(
    ...
    @pytest.mark.parametrize(
        'in_,out', [
            ...
            ('\u2177', True),
            pytest.param(
                '\U00010429', True, marks=pytest.mark.xfail(
                    sys.platform == 'win32' and IS_PYPY_LT_7_3_16,
    ...
    @pytest.mark.parametrize(
        'in_,out', [
            ...
            ('\u2177', False),
            pytest.param(
                '\U00010429', False, marks=pytest.mark.xfail(
                    sys.platform == 'win32' and IS_PYPY_LT_7_3_16,
    ...
    @pytest.mark.parametrize(
        'in_,out', [
            ...
            pytest.param(
                '\U00010401\U00010429', True, marks=pytest.mark.xfail(
                    sys.platform == 'win32' and IS_PYPY_LT_7_3_16,
