...
class TestHalf:
    ...
    def test_half_conversions(self):
        ...
        b_nn = b == b
        assert_equal(
            self.all_f16[b_nn].view(dtype=uint16),
        ...
        assert_equal(
            self.nonan_f16.view(dtype=uint16),
            b.view(dtype=uint16),
        )
