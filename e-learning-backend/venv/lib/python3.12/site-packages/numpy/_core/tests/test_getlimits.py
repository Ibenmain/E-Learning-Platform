...
from numpy._core.getlimits import _discovered_machar
from numpy._core.getlimits import _float_ma
...
def assert_finfo_equal(f1, f2):
    ...
    for attr in (
        'bits', 'eps', 'epsneg', 'iexp', 'machep',
        'max', 'maxexp', 'min', 'minexp', 'negep', 'nexp',
        'nmant', 'precision', 'resolution', 'tiny',
        'smallest_normal', 'smallest_subnormal',
    ):
        assert_equal(
            getattr(f1, attr), getattr(f2, attr),
...
def assert_iinfo_equal(i1, i2):
    ...
    for attr in ('bits', 'min', 'max'):
        assert_equal(
            getattr(i1, attr), getattr(i2, attr),
