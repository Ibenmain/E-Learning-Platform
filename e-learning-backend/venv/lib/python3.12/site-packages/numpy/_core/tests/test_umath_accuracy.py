...
UNARY_UFUNCS = [
    obj for obj in np._core.umath.__dict__.values() if
            ...
            for filename in files:
                ...
                with open(filepath) as fid:
                    ...
                    for datatype in np.unique(data['type']):
                        ...
                        inval = np.array(str_to_float(data_subset['input'].astype(
                            str), data_subset['type'].astype(str)), dtype=eval(datatype))
                        outval = np.array(str_to_float(data_subset['output'].astype(
                            str), data_subset['type'].astype(str)), dtype=eval(datatype))
