...
class TestMemmap:
    ...
    def test_roundtrip(self):
        # Write data to file
        fp = memmap(
            self.tmpfp, dtype=self.dtype, mode='w+',
            shape=self.shape,
        )
        fp[:] = self.data[:]
        ...
        newfp = memmap(
            self.tmpfp, dtype=self.dtype, mode='r',
            shape=self.shape,
        )
    ...
    def test_open_with_filename(self, tmp_path):
        ...
        fp = memmap(
            tmpname, dtype=self.dtype, mode='w+',
            shape=self.shape,
        )
        fp[:] = self.data[:]
        del fp
    ...
    def test_attributes(self):
        ...
        mode = 'w+'
        fp = memmap(
            self.tmpfp, dtype=self.dtype, mode=mode,
    ...
    def test_path(self, tmp_path):
        tmpname = tmp_path / 'mmap'
        fp = memmap(
            Path(tmpname), dtype=self.dtype, mode='w+',
            shape=self.shape,
        )
