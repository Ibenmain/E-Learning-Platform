...
-------------------------------------------
{}
""".format(detected, cpuinfo, auxv), prefix='\r',
    )
...
class Test_X86_Features(AbstractTest):
    ...
    features_groups = dict(
        ...
        AVX512_KNM=[
            'AVX512F', 'AVX512CD', 'AVX512ER', 'AVX512PF', 'AVX5124FMAPS',
        ...
        AVX512_CNL=[
            'AVX512F', 'AVX512CD', 'AVX512BW', 'AVX512DQ', 'AVX512VL', 'AVX512IFMA',
            'AVX512VBMI',
        ],
        AVX512_ICL=[
            'AVX512F', 'AVX512CD', 'AVX512BW', 'AVX512DQ', 'AVX512VL', 'AVX512IFMA',
        ...
        AVX512_SPR=[
            'AVX512F', 'AVX512CD', 'AVX512BW', 'AVX512DQ',
