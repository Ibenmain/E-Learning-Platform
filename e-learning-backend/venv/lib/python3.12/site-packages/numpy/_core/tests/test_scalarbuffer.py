...
class TestScalarPEP3118:
    ...
    def test_scalar_code_and_properties(self, scalar, code):
        x = scalar()
        expected = dict(
            strides=(), itemsize=x.dtype.itemsize, ndim=0,
    ...
    def _as_dict(self, m):
        return dict(
            strides=m.strides, shape=m.shape, itemsize=m.itemsize,
    ...
    def test_datetime_memoryview(self):
        ...
        expected = dict(
            strides=(1,), itemsize=1, ndim=1, shape=(8,),
    ...
    def test_str_ucs4(self, s):
        ...
        expected = dict(
            strides=(), itemsize=8, ndim=0, shape=(), format='2w',
            readonly=True,
        )
