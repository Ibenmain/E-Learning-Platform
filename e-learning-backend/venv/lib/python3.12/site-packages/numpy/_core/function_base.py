...
from .numeric import nan
from .numeric import ndim
from .numeric import result_type
...
def _linspace_dispatcher(
    start, stop, num=None, endpoint=None, retstep=None,
...
def _logspace_dispatcher(
    start, stop, num=None, endpoint=None, base=None,
...
def _geomspace_dispatcher(
    start, stop, num=None, endpoint=None, dtype=None,
    axis=None,
):
    return (start, stop)
