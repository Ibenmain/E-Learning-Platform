...
def fromarrays(
    ...
    if len(descr) != len(arrayList):
        raise ValueError(
            'mismatch between the number of fields '
...
def fromrecords(
    ...
    if formats is None and dtype is None:  # slower
        ...
        return fromarrays(
            arrlist, formats=formats, shape=shape, names=names,
...
def array(
    ...
    if (
        (isinstance(obj, (type(None), str)) or hasattr(obj, 'readinto')) and
