...
from .numerictypes import bytes_
from .numerictypes import character
from .numerictypes import str_
...
class chararray(ndarray):
    ...
    """
    def __new__(
        subtype, shape, itemsize=1, unicode=False, buffer=None,
...
def array(obj, itemsize=None, copy=True, unicode=None, order=None):
    ...
    if isinstance(obj, (bytes, str)):
        ...
        return chararray(
            shape, itemsize=itemsize, unicode=unicode,
