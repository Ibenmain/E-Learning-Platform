...
__all__ = [
    'poly', 'roots', 'polyint', 'polyder', 'polyadd',
...
from numpy._core import (
    isscalar, abs, finfo, atleast_1d, hstack, dot, array,
    ones,
)
            ...
            if k > 0:
                if newstr != '':
                    if newstr.startswith('-'):
                        thestr = '{} - {}'.format(thestr, newstr[1:])
                    else:
                        thestr = '{} + {}'.format(thestr, newstr)
            else:
                thestr = newstr
