...
class TestUnique:
    ...
    def test_unique_axis_zeros(self):
        ...
        uniq, idx, inv, cnt = unique(
            single_zero, axis=0, return_index=True,
        ...
        uniq, idx, inv, cnt = unique(
            single_zero, axis=1, return_index=True,
            return_inverse=True, return_counts=True,
        )
    ...
    def test_unique_masked(self):
        # issue 8664
        x = np.array(
            [64, 0, 1, 2, 3, 63, 63, 0, 0, 0, 1, 2, 0, 63, 0],
            dtype='uint8',
        )
