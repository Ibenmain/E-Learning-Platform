...
class TestRegression:
    ...
    def test_mem_vectorise(self):
        ...
        vt(
            np.zeros((1, 2, 1)), np.zeros((2, 1, 1)), np.zeros((
                1,
                1, 2,
            )), np.zeros((2, 2)),
        )
    ...
    def test_polyfit_build(self):
        # Ticket #628
        ref = [
            -1.06123820e-06, 5.70886914e-04, -1.13822012e-01,
        ...
        y = [
            9.0, 3.0, 7.0, 4.0, 4.0, 8.0, 6.0, 11.0, 9.0, 8.0, 11.0, 5.0,
