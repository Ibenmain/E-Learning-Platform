...
from numpy.lib._npyio_impl import recfromcsv
from numpy.lib._npyio_impl import recfromtxt
...
class TestSaveTxt:
    ...
    def test_unicode(self):
        ...
        with tempdir() as tmpdir:
            ...
            np.savetxt(
                os.path.join(tmpdir, 'test.csv'), a, fmt=['%s'],
                encoding='UTF-8',
            )
    ...
    def test_unicode_roundtrip(self):
        ...
        with tempdir() as tmpdir:
            for suffix in suffixes:
                np.savetxt(
                    os.path.join(tmpdir, 'test.csv' + suffix), a,
...
class LoadTxtBase:
    ...
    def test_converters_decode(self):
        ...
        c.seek(0)
        x = self.loadfunc(
            c, dtype=np.str_, encoding='bytes',
...
class TestLoadTxt(LoadTxtBase):
    ...
    def test_comments_multi_chars(self):
        ...
        c.seek(0)
        assert_raises(
            ValueError, np.loadtxt, c, dtype=int, delimiter=',',
            comments='/*',
        )
    ...
    def test_dtype_with_object(self):
        ...
        converters = {1: func}
        test = np.loadtxt(
            TextIO(data), delimiter=';', dtype=ndtype,
    ...
    def test_binary_load(self):
        ...
        with temppath() as path:
            ...
            x = [b'5,6,7,\xc3\x95scarscar',
                 b'15,2,3,hello', b'20,2,3,\xc3\x95scar']
    ...
    def test_max_rows_empty_lines(self, skip, data):
        with pytest.warns(
            ...
            res = np.loadtxt(
                data, dtype=int, skiprows=skip, delimiter=',',
                max_rows=3-skip,
            )
...
class Testfromregex:
    ...
    def test_record_unicode(self, path_type):
        ...
        with temppath() as str_path:
            ...
            a = np.array(
                [
                    (1.312, 'foo' + utf8.decode('UTF-8')), (1.534, 'bar'),
                    (4.444, 'qux'),
                ], dtype=dt,
            )
            assert_array_equal(x, a)
...
M   33  21.99
    ...
    def test_dtype_with_converters_and_usecols(self):
        ...
        test = recfromcsv(
            TextIO(dstr), dtype=dtyp, delimiter=',',
    ...
    def test_userconverters_with_explicit_dtype(self):
        ...
        test = np.genfromtxt(
            data, delimiter=',', names=None, dtype=float,
    ...
    def test_utf8_userconverters_with_explicit_dtype(self):
        ...
        with temppath() as path:
            ...
            test = np.genfromtxt(
                path, delimiter=',', names=None, dtype=float,
                usecols=(2, 3), converters={2: str},
                encoding='UTF-8',
            )
        control = np.array(
            [('2001-01-01' + utf8.decode('UTF-8'), 1.)],
            dtype=[('', '|U11'), ('', float)],
        )
        assert_equal(test, control)
    ...
    def test_fancy_dtype_alt(self):
        ...
        data = TextIO('1,2,3.0\n4,5,6.0\n')
        fancydtype = np.dtype([('x', int), ('y', [('t', int), ('s', float)])])
        test = np.genfromtxt(data, dtype=fancydtype,
    ...
    def test_user_missing_values(self):
        ...
        #
        test = np.genfromtxt(
            TextIO(data), missing_values='N/A',
            **basekwargs,
        )
        control = ma.array(
            [
    ...
    def test_user_filling_values(self):
        ...
        data2 = '1,2,*,4\n5,*,7,8\n'
        test = np.genfromtxt(
            TextIO(data2), delimiter=',', dtype=int,
    ...
    def test_invalid_raise(self):
        ...
        mdata.seek(0)
        assert_raises(
            ValueError, np.genfromtxt, mdata,
    ...
    def test_max_rows(self):
        ...
        assert_raises(
            ValueError, np.genfromtxt, TextIO(data), skip_footer=1,
            max_rows=4,
        )
