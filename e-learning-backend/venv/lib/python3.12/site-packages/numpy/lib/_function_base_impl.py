...
from numpy._core import transpose
...
from numpy._core.fromnumeric import sum
from numpy._core.multiarray import _monotonicity
from numpy._core.multiarray import _place
...
from numpy._core.umath import add
from numpy._core.umath import arctan2
from numpy._core.umath import cos
from numpy._core.umath import exp
from numpy._core.umath import frompyfunc
from numpy._core.umath import less_equal
from numpy._core.umath import minimum
from numpy._core.umath import mod
from numpy._core.umath import not_equal
from numpy._core.umath import pi
from numpy._core.umath import sin
from numpy._core.umath import sqrt
from numpy._core.umath import subtract
from numpy._utils import set_module
from numpy.lib._histograms_impl import histogram
from numpy.lib._histograms_impl import histogramdd
...
def rot90(m, k=1, axes=(0, 1)):
    ...
    if (
        axes[0] >= m.ndim or axes[0] < -m.ndim
...
def _average_dispatcher(
    a, axis=None, weights=None, returned=None, *,
    keepdims=None,
):
    return (a, weights)
...
def select(condlist, choicelist, default=0):
    ...
    choicelist.append(
        default if type(default) in (int, float, complex)
        ...
        if isinstance(otypes, str):
            for char in otypes:
                if char not in typecodes['All']:
                    raise ValueError(
                        'Invalid otype specified: {}'.format(char))
...
def _cov_dispatcher(
    m, y=None, rowvar=None, bias=None, ddof=None,
...
def _corrcoef_dispatcher(
    x, y=None, rowvar=None, bias=None, ddof=None, *,
    dtype=None,
):
    return (x, y)
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    """
    return _ureduce(
        a, func=_median, keepdims=keepdims, axis=axis, out=out,
...
def _lerp(a, b, t, out=None):
    ...
    subtract(
        b, diff_b_a * (1 - t), out=lerp_interpolation, where=t >= 0.5,
...
def _closest_observation(n, quantiles):
    ...
    return _discrete_interpolation_to_boundaries(
        (n * quantiles) - 1 - 0.5,
        gamma_fun,
    )
...
def _quantile(
    ...
    if weights is None:
        ...
        if method_props['fix_gamma'] is None:
            ...
            int_virtual_indices = np.issubdtype(
                virtual_indexes.dtype,
                np.integer,
            )
