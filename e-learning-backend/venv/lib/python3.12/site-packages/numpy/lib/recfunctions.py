...
def _merge_arrays_dispatcher(
    seqarrays, fill_value=None, flatten=None,
...
def append_fields(
    ...
    if len(data) > 1:
        data = merge_arrays(
            data, flatten=True, usemask=usemask,
...
def rec_append_fields(base, names, data, dtypes=None):
    ...
    return append_fields(
        base, names, data=data, dtypes=dtypes,
...
def _stack_arrays_dispatcher(
    arrays, defaults=None, usemask=None,
...
def rec_join(
    ...
    """
    kwargs = dict(
        jointype=jointype, r1postfix=r1postfix, r2postfix=r2postfix,
