...
import pytest
from numpy.f2py.symbolic import ArithOp
from numpy.f2py.symbolic import as_apply
from numpy.f2py.symbolic import as_array
from numpy.f2py.symbolic import as_complex
from numpy.f2py.symbolic import as_deref
from numpy.f2py.symbolic import as_eq
from numpy.f2py.symbolic import as_expr
from numpy.f2py.symbolic import as_factors
from numpy.f2py.symbolic import as_ge
from numpy.f2py.symbolic import as_gt
from numpy.f2py.symbolic import as_le
from numpy.f2py.symbolic import as_lt
from numpy.f2py.symbolic import as_ne
from numpy.f2py.symbolic import as_number
...
from numpy.f2py.symbolic import as_terms
from numpy.f2py.symbolic import as_ternary
from numpy.f2py.symbolic import eliminate_quotes
from numpy.f2py.symbolic import Expr
from numpy.f2py.symbolic import fromstring
...
class TestSymbolic(util.F2PyTest):
    ...
    def test_tostring_c(self):
        ...
        assert (
            as_apply(
                ArithOp.DIV, x,
                x + y,
            ).tostring(language=language) == 'x / (x + y)'
        )
        assert (
            as_apply(
                ArithOp.DIV, x - y, x +
        ...
        assert (
            x + (x - y) / (x + y) +
            n
        ).tostring(language=language) == '123 + x + (x - y) / (x + y)'
    ...
    def test_substitute(self):
        ...
        assert as_ternary(
            x, y,
            z,
        ).substitute({x: y + z}) == as_ternary(y + z, y, z)
