...
def buildhooks(pymod):
    from . import rules
    ret = {
        'f90modhooks': [], 'initf90modhooks': [], 'body': [],
    ...
    for m in findf90modules(pymod):
        ...
        for n in onlyvars:
            ...
            if isallocatable(var):
                ...
                iadd('\tf2py_{}_def[i_f2py++].func = {};'.format(m['name'], n))
        ...
        if hasbody(m):
            for b in m['body']:
                ...
                if isfunction(b):
                    ...
                    if wrap:
                        fhooks[0] = fhooks[0] + wrap
                        fargs.append('f2pywrap_{}_{}'.format(
                            m['name'], b['name']))
                        ifargs.append(
        ...
        ret['initf90modhooks'] = [
            '\tPyDict_SetItemString(d, "{}", PyFortranObject_New(f2py_{}_def,f2py_init_{}));'.format(
