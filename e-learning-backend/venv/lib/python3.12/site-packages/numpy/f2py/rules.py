...
from .auxfuncs import applyrules
from .auxfuncs import debugcapi
from .auxfuncs import dictappend
from .auxfuncs import errmess
from .auxfuncs import gentitle
from .auxfuncs import getargs2
from .auxfuncs import hascallstatement
from .auxfuncs import hasexternals
from .auxfuncs import hasinitvalue
from .auxfuncs import hasnote
from .auxfuncs import hasresultnote
from .auxfuncs import isarray
from .auxfuncs import isarrayofstrings
from .auxfuncs import isattr_value
from .auxfuncs import ischaracter
from .auxfuncs import ischaracter_or_characterarray
from .auxfuncs import ischaracterarray
from .auxfuncs import iscomplex
from .auxfuncs import iscomplexarray
from .auxfuncs import iscomplexfunction
from .auxfuncs import iscomplexfunction_warn
from .auxfuncs import isdummyroutine
from .auxfuncs import isexternal
from .auxfuncs import isfunction
from .auxfuncs import isfunction_wrap
from .auxfuncs import isint1
from .auxfuncs import isint1array
from .auxfuncs import isintent_aux
from .auxfuncs import isintent_c
from .auxfuncs import isintent_callback
from .auxfuncs import isintent_copy
from .auxfuncs import isintent_hide
from .auxfuncs import isintent_inout
from .auxfuncs import isintent_nothide
from .auxfuncs import isintent_out
from .auxfuncs import isintent_overwrite
from .auxfuncs import islogical
from .auxfuncs import islong_complex
from .auxfuncs import islong_double
from .auxfuncs import islong_doublefunction
from .auxfuncs import islong_long
from .auxfuncs import islong_longfunction
from .auxfuncs import ismoduleroutine
from .auxfuncs import isoptional
from .auxfuncs import isrequired
from .auxfuncs import isscalar
from .auxfuncs import issigned_long_longarray
from .auxfuncs import isstring
from .auxfuncs import isstringarray
from .auxfuncs import isstringfunction
from .auxfuncs import issubroutine
from .auxfuncs import issubroutine_wrap
from .auxfuncs import isthreadsafe
from .auxfuncs import isunsigned
from .auxfuncs import isunsigned_char
from .auxfuncs import isunsigned_chararray
from .auxfuncs import isunsigned_long_long
from .auxfuncs import isunsigned_long_longarray
from .auxfuncs import isunsigned_short
from .auxfuncs import isunsigned_shortarray
from .auxfuncs import l_and
from .auxfuncs import l_not
from .auxfuncs import l_or
from .auxfuncs import outmess
from .auxfuncs import replace
from .auxfuncs import requiresf90wrapper
from .auxfuncs import stripcomma
...
rout_rules = [
    {  # Init
        ...
        'functype': 'void',
        'declfortranroutine': {
            l_and(l_not(l_or(ismoduleroutine, isintent_c)), l_not(isdummyroutine)): 'extern void #F_FUNC#(#fortranname#,#FORTRANNAME#)(#callprotoargument#);',
        ...
        'functype': 'void',
        'declfortranroutine': {
            l_not(l_or(ismoduleroutine, isdummyroutine)): 'extern void #F_WRAPPEDFUNC#(#name_lower#,#NAME#)(#callprotoargument#);',
            isdummyroutine: '',
        },
    ...
    if (#setjmpbuf#) {
        ...
        'callfortranroutine': [
            {
                l_and(debugcapi, isstringfunction): """\
...
""",
        ...
        'declfortranroutine': {
            l_and(l_not(l_or(ismoduleroutine, isintent_c)), l_not(isdummyroutine)): 'extern #ctype# #F_FUNC#(#fortranname#,#FORTRANNAME#)(#callprotoargument#);',
...
""",
    ...
    if (f2py_success) {""",
        ...
        '_check': l_and(
            isscalar, l_not(iscomplex), l_not(isstring),
            isintent_nothide,
        ),
    }, {
        'frompyobj': [
...
def buildmodule(m, um):
    ...
    needs['typedefs'] += [
        cvar for cvar in capi_maps.f2cmap_mapped #
