...
class TestFFT1D:
    ...
    def test_identity(self):
        ...
        for i in range(1, maxlen):
            assert_allclose(
                np.fft.ifft(np.fft.fft(x[0:i])), x[0:i],
                atol=1e-12,
            )
            assert_allclose(
                np.fft.irfft(np.fft.rfft(xr[0:i]), i),
                xr[0:i], atol=1e-12,
            )
...
def test_irfft_with_n_large_regression():
    ...
    expected = np.array([
        20., 9.91628173, -11.8819096, 7.1048486,
