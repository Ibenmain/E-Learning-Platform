...
class CredentialsWithQuotaProject(Credentials):
    ...
    def with_quota_project(self, quota_project_id):
        ...
        raise NotImplementedError(
            'This credential does not support quota project.')

    def with_quota_project_from_environment(self):
        quota_from_env = os.environ.get(
            environment_vars.GOOGLE_CLOUD_QUOTA_PROJECT)
        if quota_from_env:
    ...
    def apply(self, headers, token=None):
        ...
        if token is not None:
            raise exceptions.InvalidValue(
                "Anonymous credentials don't support tokens.")
