...
_METADATA_ROOT = f'http://{_GCE_METADATA_HOST}/computeMetadata/v1/'
...
def detect_gce_residency_linux():
    ...
    """
    try:
        with open(_GCE_PRODUCT_NAME_FILE) as file_obj:
...
def get_service_account_info(request, service_account='default'):
    ...
    Raises:
        google.auth.exceptions.TransportError: if an error occurred while
            retrieving metadata.
    """
    path = f'instance/service-accounts/{service_account}/'
...
def get_service_account_token(request, service_account='default', scopes=None):
    ...
    path = f'instance/service-accounts/{service_account}/token'
