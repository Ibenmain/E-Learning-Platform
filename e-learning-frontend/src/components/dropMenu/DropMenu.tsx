        ...
        <div className="bg-[#9fef00] flex items-center gap-4 rounded-[3px]">
            <DropdownMenu onOpenChange={(isOpen) => setOpen(isOpen)} >
                ...
                <DropdownMenuContent className="font-semibold text-black dark:text-white space-y-1">
                    <DropdownMenuItem onClick={() => {navigate('/profile')}} className="flex justify-center items-center font-semibold ">
                        Profile
                    </DropdownMenuItem>
                    <DropdownMenuItem  onClick={() => {navigate('/settings')}} className="flex justify-center items-center">
                        Settings
                    </DropdownMenuItem>
